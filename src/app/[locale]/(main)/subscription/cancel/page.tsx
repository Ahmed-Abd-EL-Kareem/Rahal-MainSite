...
export default function SubscriptionCancelPage({ params }: PageProps) {
    ...
    <main className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-xl w-full text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            {t('subscriptionCancel.retryPayment')}
          </Button>
          <Link href={`/${locale}/account?tab=subscription`}>
            <Button variant="secondary" className="px-8 py-3.5 rounded-xl font-bold text-sm w-full">
              {t('subscriptionCancel.goToAccount')}
            </Button>
          </Link>
        </div>
      </div>
